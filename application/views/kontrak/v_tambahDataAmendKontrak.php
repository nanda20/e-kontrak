...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<br />
				<form  action="<?= base_url()?>DataMaster/tambahDataAmendKontrak" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >
				...
				<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							...
							<?php foreach ($kontrak as $val): ?>
								<option value="<?= $val->idKontrak; ?>" > <?= $val->nomorKontrak; ?> </option>
							<?php endforeach ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="" name="nomorAmendKontrak" />
						</div>
					</div>
                    <div class="form-group">
						...
						<input type="date" name="tanggalAmend" id="datepicker" value=""/> /
						</div>
					...
					<div class="form-group">
						...
						<input type="date" name="tanggalMulai" id="datepicker" value=""/> /
						<input type="date" name="tanggalSelesai" id="datepicker" value=""/>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							 ...
							 <!--<a  data-toggle="tooltip" data-original-title="click to view"   target="_blank" href=" ">-->
