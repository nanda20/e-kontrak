			...
			<div class="x_content">
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
						...
						<input type="date" name="tanggalKontrak" id="datepicker" value=""/> 
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value=" " name="jangkaWaktuPembayaran" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select class="form-control" name="kategori">
								...
								<option value="Transportrasi"  > Transportrasi </option>
							</select>
						</div>
					</div>
