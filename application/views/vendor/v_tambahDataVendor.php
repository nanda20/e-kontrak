...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<br />
				<form  action="<?= base_url()?>DataMaster/tambahDataVendor" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
					...
					<div class="form-group">
						<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
							...
							<button onclick="window.location.href='<?= base_url()?>DataMaster/viewDataVendor'" class="btn btn-primary" type="button">Cancel</button>
